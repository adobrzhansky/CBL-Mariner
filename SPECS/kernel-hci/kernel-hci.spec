...
Patch84:        0085-net-mlx5-DR-Prefer-kcalloc-over-open-coded-arithmeti.patch
Patch85:        0086-net-mlx5-Bridge-Enable-mcast-in-smfs-steering-mode.patch
Patch86:        0087-net-mlx5-DR-Add-check-for-multi-destination-FTE.patch
Patch87:        0088-net-mlx5-DR-Handle-multi-destination-action-in-the-r.patch
Patch88:        0089-net-mlx5-DR-Align-mlx5dv_dr-API-vport-action-with-FW.patch
Patch89:        0090-net-mlx5-Lag-add-debugfs-to-query-hardware-lag-state.patch
...
%changelog
* Fri Jan 05 2024 Vince Perri <viperri@microsoft.com> - 5.15.139.1-2
- Add net/mlx5 patches (28-89) that backports upstream near-edge improvements and support for 100GB BOM.
