...
# configuration-clh: vanilla Kata - kernel & initrd, confidential_guest=false, sev_snp_guest=false
...
# - Set up configuration-clh-snp-debug. Note that kernel, image and
#   confidential_guest are already set through configuration-clh.
